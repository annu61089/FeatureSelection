...
public class WhitespaceTokenizer extends AbstractTokenizer {
    ...
    public List<String> tokenize(String text) {
        List<String> tokens = new ArrayList<>(Arrays.asList(text.split("[\\p{Z}\\p{C}@+-?,<>!#$%^&*._()0-9\"]+")));
        return tokens;
    }

//    public List<String> TrimUnwantedCharacters(List<String> tokenss)
//    {
//        //String tt =  "sdfsdf";
//        //tt.replaceAll()
//        String replaceCharsRegex =  "[., /, \\, _ ]";
//        tokenss.forEach( s -> s.replaceAll());
//
//    }
